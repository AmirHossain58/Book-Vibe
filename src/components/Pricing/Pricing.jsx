		...
		<div className="flex flex-wrap items-stretch -mx-4">
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-50">
					...
					<p className="mt-3 leading-relaxed dark:text-gray-600">Embark on your learning journey with our beginner-friendly resources, all completely free!</p>
			...
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-violet-600 dark:text-gray-50">
					...
					<p className="leading-relaxed">Elevate your skills like a pro for just $24/month! Unlock premium features and take your expertise to new heights. </p>
			...
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-50">
					...
					<p className="leading-relaxed dark:text-gray-600">Empower your team with our comprehensive toolkit for only $72/month! Drive collaboration, efficiency, and success together. </p>
